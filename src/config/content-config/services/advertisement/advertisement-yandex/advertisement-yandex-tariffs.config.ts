    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Разрабатывает и оптимизирует рекламные кампании, контролирует бюджет и эффективность, применяя передовые методы и инструменты.",
        },
        {
          title: "Копирайтер",
          description:
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Выполняют настройку и управление таргетированными рекламными кампаниями; количество специалистов зависит от сложности и объема проекта.",
        },
        {
          title: "Копирайтер",
          description:
