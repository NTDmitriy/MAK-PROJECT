    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Разрабатывает стратегию контекстных рекламных кампаний, руководит контекстологами, обеспечивает оптимизацию и контроль их работы.",
        },
        {
          title: "1-3 таргетолога",
          description: 'Занимаются настройкой и управлением контекстной рекламой; количество специалистов зависит от сложности и объема проекта.',
        },
        {
          title: "Копирайтер",
          description:
