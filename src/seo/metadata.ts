...
export const METADATA = {
  ...
  PROMOTION_ONLINE_SCHOOL: {
    title: "Продвижение онлайн-школ | Увеличение продаж и привлечение учеников",
    description:
  ...
  INTERIOR_DESIGN_STUDIO: {
    title: `Кейс: Разработка сайта для студии дизайна и архитектуры "ROYAL 33"`,
    description:
      "Узнайте, как мы создали сайт для студии ROYAL 33, которая занимается разработкой элитных интерьеров. Мы воплотили в жизнь стильный и функциональный сайт, который подчеркивает премиум-уровень услуг и удобство для клиентов.",
  },
  ACTIVE_VACATION: {
    title: `Кейс: Разработка сайта для компании "Активный отдых Владимир"`,
    description:
      "Как мы разработали сайт для компании «Активный отдых Владимир», предлагающей уникальные экскурсии с использованием FPV-технологий. Современный и удобный интерфейс, который помогает клиентам легко находить информацию и бронировать экскурсии.",
  },
  ...
  ADS_GOOGLE_GUIDE: {
    ...
    description:
      "Узнайте, как продвигаться в Google в 2024 году без контекстной рекламы. Ключевые SEO-стратегии, технические аспекты и аналитика для достижения высоких позиций в органической выдаче.",
    author: "Make All Perfect",
    images: IMAGES,
  },
