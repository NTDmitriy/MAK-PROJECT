    ...
    <Section className={className} {...rest}>
      ...
      <Container>
        <p className={styles.text_main}>
          ...
          цикла, работающее по всей России и миру. Мы гордимся тем, что на
          протяжении уже 7 лет помогаем компаниям достигать высоких результатов
        ...
        <div className={styles.content_bottom}>
          <div className={styles.text_cont}>
            <p className={styles.text_main}>
              ...
              вашего бизнеса. Наша цель – помочь вам достигать новых высот и
              уверенно идти к успеху.
            </p>
            <p className={styles.text_main}>
