    ...
    <div>
        <div className={styles.container}>
            ...
            <picture>
                ...
                <p className={styles.achievment}>Founder & CEO (Основатель и Генеральный директор)  </p>
                <p className={styles.descr}>Основатель и генеральный директор нашей компании. Под его руководством мы стали одной из самых инновационных и быстро развивающихся компаний. Его дальновидный подход и способность предвидеть рыночные тренды помогают нам создавать решения, которые идеально соответствуют актуальным потребностям клиентов. Дмитрий вдохновляет команду на достижение высоких результатов и воплощение амбициозных проектов, которые приносят ощутимую пользу нашим клиентам.</p>
                <p className={styles.quote}><span className={styles.quote_span}><QouteIcon /></span>Видеть возможности там, где другие видят препятствия.</p>
            </div>
            <div className={styles.workers_container}>
              ...
              <div className={styles.worker_info}>
                ...
                <p className={styles.worker_descr}>CMO (Chief Marketing Officer, Директор по маркетингу)  </p>
                <div className={styles.skills}>
                    <p className={styles.skill_name}>Digital marketing</p>
                    <p className={styles.skill_name}>Платная реклама (PPC)</p>
                    <p className={styles.skill_name}>Поисковое продвижение (SEO)</p>
                </div>
              </div>
                </div>
                <div className={styles.worker}>
              ...
              <div className={styles.worker_info}>
                ...
                <p className={styles.worker_descr}>Head of Design (Руководитель отдела дизайна)  </p>
                <div className={styles.skills}>
              ...
              <div className={styles.worker_info}>
                ...
                <p className={styles.worker_descr}>CTO (Chief Technology Officer, Главный технический директор)  </p>
                <div className={styles.skills}>
              ...
              <div className={styles.worker_info}>
                ...
                <p className={styles.worker_descr}>Team Lead Web Development (Руководитель команды веб-разработки)  </p>
                <div className={styles.skills}>
