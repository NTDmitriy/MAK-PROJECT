    ...
    <>
      ...
      <CaseBoxWithe>
        ...
        <CaseList marketed black>
          <CaseListItem>
            Низкая видимость сайта в поисковых системах, что приводило к недостаточному органическому трафику
          </CaseListItem>
          <CaseListItem>
      ...
      <Box>
        ...
        <CaseList marketed margin>
          <CaseListItem>
            Провели полный аудит сайта, выявив основные технические ошибки и проблемы, мешающие эффективному ранжированию в поисковых системах.
          </CaseListItem>
          <CaseListItem>
        ...
        <CaseList marketed margin>
          ...
          <CaseListItem>
            Настроили новые кампании с использованием точного таргетинга и ретаргетинга, чтобы привлечь более релевантный трафик.
          </CaseListItem>
          <CaseListItem>
        ...
        <CaseList marketed margin>
          ...
          <CaseListItem>
            ...
            по продажам и маркетингу и получить полное представление о рентабельности различных каналов.
          </CaseListItem>
          <CaseListItem>
            Регулярно анализировали данные аналитики, выявляли узкие места и вносили корректировки в маркетинговую стратегию для повышения
            эффективности.
          </CaseListItem>
        </CaseList>
        <CaseList>
