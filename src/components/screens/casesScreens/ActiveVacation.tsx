...
export const ActiveVacation: FC = () => {
  ...
  return (
    <>
      ...
      <Box>
        <CaseText margin>
          Компания "Active Vladimir" обратилась в наше маркетинговое агентство
          с целью создания инновационного веб-сайта. Основная задача заключалась
          в разработке онлайн-платформы для продвижения уникальной услуги —
      ...
      <Box>
        ...
        <CaseText>
          "Active Vladimir" — инновационная компания в сфере туризма
          и развлечений, предлагающая уникальные экскурсии по Владимиру в FPV
      ...
      <Box>
        ...
        <CaseList marketed>
          <CaseListItem>
            <CaseTextAccent>Туристы</CaseTextAccent> ищущие новые впечатления
            и необычные экскурсии.
          </CaseListItem>
          <CaseListItem>
            <CaseTextAccent>Жители Владимира</CaseTextAccent> заинтересованные
            в активном отдыхе и новых развлечениях
          </CaseListItem>
          <CaseListItem>
            <CaseTextAccent>
      ...
      <Box>
        ...
        <CaseList marketed margin>
          ...
          <CaseListItem>
            Создать контент, объясняющий преимущества и уникальность экскурсий
            в FPV очках.
          </CaseListItem>
          <CaseListItem>
      ...
      <Box>
        ...
        <CaseList marketed>
          <CaseListItem>
            Создать визуально привлекательный сайт с акцентом
            на инновационность.
          </CaseListItem>
          <CaseListItem>
      ...
      <Box>
        ...
        <CaseList>
          ...
          <CaseListItem>
            <CaseTextAccent>Email-маркетинг:</CaseTextAccent> Подписка
            на новости и специальные предложения, интеграция с Mailchimp.
          </CaseListItem>
        </CaseList>
      </Box>
      ...
      <Box>
        ...
        <CaseList>
          <CaseListItem>
            ...
            бронирований выросло, и мы получаем много положительных отзывов
            от клиентов о простоте использования сайта."
          </CaseListItem>
          <CaseListItem>
