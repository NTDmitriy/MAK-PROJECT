  ...
  return (
    <>
      ...
      <Box>
        ...
        <CaseList marketed margin>
          <CaseListItem>
            Запустили таргетированные рекламные кампании, ориентированные на жителей Санкт-Петербурга, интересующихся стоматологическими
            услугами.
          </CaseListItem>
          <CaseListItem>
            Разработали контент-план для ведения страницы клиник в ВКонтакте,
            включая публикации о преимуществах клиники, отзывы клиентов и полезные советы по уходу за зубами.
          </CaseListItem>
        </CaseList>
        ...
        <CaseList marketed margin>
          <CaseListItem>
            Оптимизировали сайт под брендовые запросы, улучшив его видимость в поисковых системах.
          </CaseListItem>
          <CaseListItem>
