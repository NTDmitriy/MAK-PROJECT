      ...
      <Box>
        ...
        <CaseList marketed margin>
          <CaseListItem>
            ...
            рекламных аккаунта, что позволило разнообразить подходы и протестировать различные рекламные стратегии.
          </CaseListItem>
          <CaseListItem>
        ...
        <CaseList marketed margin>
          <CaseListItem>
            Запустили рекламные кампании, ориентированные на интересы и поведение пользователей в ВКонтакте.
          </CaseListItem>
          <CaseListItem>
