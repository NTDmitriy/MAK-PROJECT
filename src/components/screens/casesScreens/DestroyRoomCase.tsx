    ...
    <>
      ...
      <Box>
        ...
        <CaseList marketed margin>
          ...
          <CaseListItem>
            ...
            таргетинг на Москву и ближайшие районы, время показа объявлений — с учётом пиков активности целевой аудитории
          </CaseListItem>
          <CaseListItem>
            <CaseTextAccent>Ретаргетинг:</CaseTextAccent> Запустили кампании на пользователей, ранее посещавших сайт или совершавших взаимодействия
            в социальных сетях.
          </CaseListItem>
        </CaseList>
      ...
      <Box>
        ...
        <CaseList marketed gap>
          <CaseListItem>
            <CaseTextAccent>Точный таргетинг</CaseTextAccent> на заинтересованную аудиторию с учётом её поведения и предпочтений.
          </CaseListItem>
          <CaseListItem>
            <CaseTextAccent>
          ...
          <CaseListItem>
            <CaseTextAccent>Постоянная оптимизация</CaseTextAccent> кампании на основе аналитики и результатов.
          </CaseListItem>
        </CaseList>
      </Box>
