    ...
    <>
      ...
      <Box>
        <div className={styles.tasks}>
          ...
          <ul className={styles.text_list}>
            <li className={styles.text_info}>
              <span className={styles.text_info_white}>Аудит: </span>Мы провели
              детальный аудит текущих рекламных кампаний и сайта. Это позволило
              выявить основные проблемы и определить точки роста.
            </li>
            <li className={styles.text_info}>
              <span className={styles.text_info_white}>Анализ ниши: </span>
              Исследование ниши и конкурентной среды помогло понять поведение
              целевой аудитории и выявить уникальные торговые предложения (УТП)
              конкурентов.
            </li>
          </ul>
          ...
          <ul className={styles.text_list}>
            <li className={styles.text_info}>
              ...
              Настроили эффективные кампании в Яндекс.Директ, ориентированные на
          ...
          <div className={styles.tasks}>
            ...
            <p className={styles.text_full}>
              ...
              может значительно улучшить ключевые показатели бизнеса и укрепить
