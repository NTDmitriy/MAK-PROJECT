...
export const UsefulScreen: FC<PropsWithChildren<IUsefulScreen>> = ({
  ...
  return (
    <>
      ...
      {content.howAffiliateWork && (
        <HowAffiliateWork howAffiliateWorkContent={content.howAffiliateWork} />
      )}
      ...
      {content.partnerBenefits && (
        <WhyUs whyUsContent={content.partnerBenefits} />
      )}
