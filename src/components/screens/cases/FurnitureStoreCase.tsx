        ...
        <Container>
          <div className={styles.content_hero}>
            <h2 className={styles.hero_title}>
              Комплексное увеличение продаж и оптимизация маркетинговых усилий
              для компании по продаже мебели
            </h2>
          ...
          <div className={styles.tasks}>
            ...
            <ul className={styles.text_list}>
              <li className={styles.text_info}>
                ...
                проблемы, мешающие эффективному ранжированию в поисковых
                системах.
              </li>
              <li className={styles.text_info}>
            ...
            <ul className={styles.text_list}>
              ...
              <li className={styles.text_info}>
                ...
                данные по продажам и маркетингу и получить полное представление
                о рентабельности различных каналов.
              </li>
              <li className={styles.text_info}>
