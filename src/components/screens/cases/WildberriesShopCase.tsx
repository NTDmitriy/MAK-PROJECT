        ...
        <div className={styles.tasks}>
          ...
          <ul className={styles.text_list}>
            ...
            <li className={styles.text_info}>
              ...
              пользователей на сайте Wildberries, выявления узких мест и
            ...
            <li className={styles.text_info}>
              ...
              позволял охватить более широкую аудиторию и увеличить объем
              трафика.
            </li>
          </ul>
          <div className={styles.tasks}>
            ...
            <ul className={styles.text_list}>
              ...
              <li className={styles.text_info}>
                Приведенный внешний трафик поспособствовал укреплениям позиций в
                органической выдачи, что
                <span className={styles.text_info_yellow}>
                  {" "}
