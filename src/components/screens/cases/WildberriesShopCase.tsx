...
> = ({ className, ...rest }) => {
  return (
    <>
      <Breadcrumbs pathname={CASES_DASHBOARD_PAGES.WILDBERRIES_SHOP.url} />
      <Section className={className} {...rest}>
        <Container>
          <div className={styles.content_hero}>
            <h2 className={styles.hero_title}>
              Увеличение продаж магазина женской одежды на Wildberries
            </h2>
            <p className={`${styles.text} ${styles.text_hero}`}>
              Проект по продвижению магазина женской одежды на платформе
              Wildberries через рекламу в ВКонтакте и Яндекс.
            </p>
          </div>
          ...
          <Container className={styles.problems_content}>
            ...
            <ul className={styles.text_list}>
              <li className={`${styles.text_info} ${styles.text_problems}`}>
                Низкая видимость и конкурентоспособность на платформе
                Wildberries.
              </li>
              <li className={`${styles.text_info} ${styles.text_problems}`}>
          ...
          <div className={styles.tasks}>
            ...
            <ul className={styles.text_list}>
              ...
              <li className={styles.text_info}>
                ...
                подчеркивающим преимущества товаров и специальные предложения.
              </li>
              <li className={styles.text_info}>
            ...
            <ul className={styles.text_list}>
              ...
              <li className={styles.text_info}>
                ...
                низкочастотных запросов, связанных с женской одеждой и покупками
                на Wildberries.
              </li>
              <li className={styles.text_info}>
            ...
            <ul className={styles.text_list}>
              ...
              <li className={styles.text_info}>
                ...
                поведения пользователей на сайте Wildberries, выявления узких
                мест и улучшения пользовательского опыта.
              </li>
              <li className={styles.text_info}>
                Определили, что рекламные кампании в ВКонтакте генерировали
                более целевой трафик с высоким показателем конверсии, тогда как
                Яндекс позволял охватить более широкую аудиторию и увеличить
                объем трафика.
              </li>
            </ul>
            <div className={styles.tasks}>
              ...
              <ul className={styles.text_list}>
                <li className={styles.text_info}>
                  ...
                  <span className={styles.text_info_yellow}>
                    более 1500 выкупов в месяц.
                  </span>
                </li>
                <li className={styles.text_info}>
                  Стоимость привлечения одного клиента снизилась{" "}
                  <span className={styles.text_info_yellow}>на 63%,</span>что
                  повысило рентабельность рекламных кампаний.
                </li>
                <li className={styles.text_info}>
                  Приведенный внешний трафик поспособствовал укреплениям позиций
                  в органической выдачи, что
                  <span className={styles.text_info_yellow}>
                    {" "}
                    дало ощутимый рост продаж.
                  </span>
                </li>
              </ul>
            </div>
