    ...
    <>
      ...
      <Box>
          <div className={styles.content_hero}>
            ...
            <p className={styles.text}>
              Маркетинговая кампания для учебного заведения, специализирующегося
              на Frontend разработке, направленная на привлечение большего числа
              заявок и улучшение конверсии на посадочных страницах.
            </p>
          </div>
          <div className={styles.tasks}>
            ...
            <ul className={styles.text_list}>
              <li className={styles.text_info}>
                Увеличение количества заявок на бесплатные и платные
      ...
      <Box>
          <div className={styles.tasks}>
            ...
            <ul className={styles.text_list}>
              <li className={styles.text_info}>
                Для максимальной масштабируемости трафика было создано и
                настроено 4 рекламных аккаунта, что позволило разнообразить
                подходы и протестировать различные рекламные стратегии.
              </li>
              <li className={styles.text_info}>
                Мы настроили кампании, ориентированные на разные группы целевой
                аудитории, используя как общие, так и специализированные
                ключевые слова.
              </li>
            </ul>
            ...
            <ul className={styles.text_list}>
              ...
              <li className={styles.text_info}>
                ...
                карусельные объявления и видеообъявления, что позволило
                увеличить вовлеченность и CTR.
              </li>
            </ul>
            <div className={styles.tasks}>
