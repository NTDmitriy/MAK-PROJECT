...
> = ({ className, ...rest }) => {
  return (
    <>
      <Breadcrumbs pathname={CASES_DASHBOARD_PAGES.TAX_OPTIMIZATION.url} />
      <Section className={className} {...rest}>
        <Container>
          <div className={styles.content_hero}>
            <h2 className={styles.hero_title}>
              Эффективное привлечение клиентов для услуги оптимизации налогов
              на УСН
            </h2>
            <p className={styles.text}>
              Проект по продвижению услуги оптимизации налогов для
              предпринимателей на упрощенной системе налогообложения (УСН) через
          ...
          <div className={styles.tasks}>
            ...
            <ul className={styles.text_list}>
              <li className={styles.text_info}>
                Настройка и оптимизация рекламных кампаний в Яндекс Директ и
                Google Ads для привлечения целевого трафика.
              </li>
              <li className={styles.text_info}>
      ...
      <Section>
        <Container>
          <div className={styles.tasks}>
            ...
            <ul className={styles.text_list}>
              <li className={styles.text_info}>
                Провели аудит текущих рекламных кампаний и выявили ключевые
              ...
              <li className={styles.text_info}>
                Разработали привлекательные объявления с четким УТП,
                подчеркивающим выгоды от использования услуги.
              </li>
              <li className={styles.text_info}>
            ...
            <ul className={styles.text_list}>
              <li className={styles.text_info}>
                Настроили рекламные кампании в Google Ads с использованием
                поисковой и контекстно-медийной сети.
              </li>
              <li className={styles.text_info}>
              ...
              <li className={styles.text_info}>
                Запустили A/B тестирование различных объявлений, чтобы
                определить наиболее эффективные форматы и сообщения.
              </li>
              <li className={styles.text_info}>
            ...
            <ul className={styles.text_list}>
              <li className={styles.text_info}>
                {" "}
                В ходе реализации проекта было важно отслеживать качество и
                объем трафика, привлекаемого через Яндекс Директ и Google Ads.
              </li>
              <li className={styles.text_info}>
              ...
              <li className={styles.text_info}>
                Использовали инструменты веб-аналитики для отслеживания
                поведения пользователей на сайте, выявления узких мест и
            ...
            <div className={styles.tasks}>
              ...
              <ul className={styles.text_list}>
                <li className={styles.text_info}>
                  Количество целевых обращений через рекламные кампании
                  составило
                ...
                <li className={styles.text_info}>
                  ...
                  <span className={styles.text_info_yellow}>в 3 раза</span> что
                  повысило рентабельность рекламных кампаний и ROMI.
                </li>
                <li className={styles.text_info}>
                  Показатель отказов сократился{" "}
                  <span className={styles.text_info_yellow}>до 18%,</span> что
                  свидетельствует о повышении качества трафика и улучшении
                  пользовательского опыта.
                </li>
              </ul>
              <p className={styles.text_full}>
                Проект продемонстрировал, что комплексный подход к рекламе в
                Яндекс Директ и Google Ads, с акцентом на анализ и оптимизацию
                трафика, может значительно повысить эффективность маркетинговых
                усилий и обеспечить стабильный рост показателей.
              </p>
