...
> = ({ className, ...rest }) => {
  return (
    <>
      <Breadcrumbs
        pathname={CASES_DASHBOARD_PAGES.CONSTRUCTION_COMPANY.url}
      />
      <Section className={className} {...rest}>
        <Container>
          <div className={styles.content_hero}>
            <h2 className={styles.hero_title}>
              Увеличение продаж и улучшение узнаваемости бренда "Карельский дом"
            </h2>
            <p className={styles.text}>
              Комплексный маркетинговый проект по продвижению компании,
              занимающейся строительством домов из массивного бруса и каркасных
              домов, направленный на повышение продаж и узнаваемости бренда на
              рынке.
            </p>
          </div>
          <div className={styles.tasks}>
            ...
            <p className={styles.text}>
              ...
              клиентской базы компании "Карельский дом". В рамках проекта перед
        ...
        <div className={styles.tasks__problems}>
          <Container className={styles.problems_content}>
            ...
            <ul className={styles.text_list}>
              ...
              <li className={`${styles.text_info} ${styles.text_problems}`}>
                Неоптимизированный сайт, что приводило к высокому показателю
                отказов (более 45%).
              </li>
            </ul>
          </Container>
      ...
      <Section>
        <Container>
          <div className={styles.tasks}>
            ...
            <ul className={styles.text_list}>
              <li className={styles.text_info}>
                <span className={styles.text_info_white}>Аудит: </span>Мы
                провели детальный аудит текущих рекламных кампаний и сайта. Это
                позволило выявить основные проблемы и определить точки роста.
              </li>
              <li className={styles.text_info}>
                <span className={styles.text_info_white}>Анализ ниши: </span>
                Исследование ниши и конкурентной среды помогло понять поведение
                целевой аудитории и выявить уникальные торговые предложения
                (УТП) конкурентов.
              </li>
            </ul>
            ...
            <ul className={styles.text_list}>
              <li className={styles.text_info}>
                ...
                Настроили эффективные кампании в Яндекс.Директ, ориентированные
                на высокочастотные и низкочастотные запросы.
              </li>
              <li className={styles.text_info}>
                <span className={styles.text_info_white}>
                  Таргетированная реклама в социальных сетях:{" "}
                </span>
                Создали таргетированные кампании в ВКонтакте, нацеленные на
                ключевую аудиторию.
              </li>
            </ul>
            ...
            <ul className={styles.text_list}>
              <li className={styles.text_info}>
                Улучшили структуру и дизайн сайта, что сократило показатель
                отказов до 16%.
              </li>
              <li className={styles.text_info}>
                Оптимизировали мобильную версию сайта, что увеличило конверсию
                на мобильных устройствах на 20%.
              </li>
            </ul>
            ...
            <div className={styles.tasks}>
              ...
              <ul className={styles.text_list}>
                <li className={styles.text_info}>
                  ...
                  <span className={styles.text_info_yellow}> на 193%, </span>
                  достигнув
                ...
                <li className={styles.text_info}>
                  ...
                  <span className={styles.text_info_yellow}>на 37%.</span>
                </li>
                <li className={styles.text_info}>
                  Показатель отказов сократился{" "}
                  <span className={styles.text_info_yellow}>до 16%.</span>
                </li>
              </ul>
              <p className={styles.text_full}>
                Проект продемонстрировал, что комплексный подход к маркетингу
                может значительно улучшить ключевые показатели бизнеса и
