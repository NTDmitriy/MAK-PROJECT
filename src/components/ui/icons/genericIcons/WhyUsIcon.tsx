...
export const WhyUsIcon = (props: SVGProps<SVGSVGElement>) => {
  ...
  <defs>
    <linearGradient id="paint0_linear_653_832" x1="1.5" y1="15" x2="28.5" y2="15" gradientUnits="userSpaceOnUse">
      <stop stopColor="#F4A21A" />
      <stop offset="0.5" stopColor="#FFDE00" />
      <stop offset="1" stopColor="#F4A21A" />
    </linearGradient>
  </defs>
</svg>
  );
