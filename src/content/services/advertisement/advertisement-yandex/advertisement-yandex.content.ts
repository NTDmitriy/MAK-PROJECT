...
import { ADVERTISEMENT_YANDEX_INCLUDE } from "./advertisement-yandex-include";
import { TARIFFS_YANDEX } from "./advertisement-yandex-tariffs";

export const ADVERTISEMENT_YANDEX_CONTENT = {
