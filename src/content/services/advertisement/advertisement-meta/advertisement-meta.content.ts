...
import { ADVERTISEMENT_META_INCLUDE } from "./advertisement-meta-include";
import { TARIFFS_META } from "./advertisement-meta-tariffs";

export const ADVERTISEMENT_META_CONTENT = {
