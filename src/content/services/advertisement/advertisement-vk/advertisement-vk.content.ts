...
import { ADVERTISEMENT_VK_INCLUDE } from "./advertisement-vk-include";
import { TARIFFS_VK } from "./advertisement-vk-tariffs";

export const ADVERTISEMENT_VK_CONTENT = {
    ...
    infoAdvertisement: [
      {
        title: "Широкий охват:",
        description:
          "Реклама в ВКонтакте достигает миллионов активных пользователей.",
      },
      {
