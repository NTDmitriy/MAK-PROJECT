...
import { WEBDEV_REDESING_STAGES } from "./webdev-redesign-stages";
import { REDESIGN_FAQ } from "./webdev-redesing-faq";

export const WEBDEV_REDESIGN_CONTENT = {
  ...
  supplementaryDescr: {
    ...
    image: "webdev-redesign-supplementary",
