...
class ALL_CASES {
  ...
  INTERIOR_DESIGN_STUDIO = {
    id: 10,
    url: `${this.root}/razrabotka-sajta-dlya-ctudii-dizajna`,
    prevName: "Разработка сайта для cтудии дизайна",
    name: "Разработка сайта для cтудии дизайна",
    prevDescription:
    ...
    description:
      "Проект по разработке сайта для студии ROYAL 33, специализирующейся на элитном дизайне интерьеров. Создание стильного и функционального ресурса для демонстрации премиум-уровня услуг и привлечения новых клиентов.",
    image: "cases-interior-design-studio",
    categories: ["WEB-разработка", "Интеграции", "Сквозная аналитика"],
    isGlobal: true,
  } satisfies TCase;

  ACTIVE_VACATION = {
    id: 11,
    url: `${this.root}/razrabotka-sajta-aktivynj-otdyh-vo-vladimire`,
    prevName: "Экскурсии во Владимире с FPV-технологиями",
    name: "Экскурсии во Владимире с FPV-технологиями",
    prevDescription:
      "Проект по разработке сайта для компании «Активный отдых Владимир», предлагающей уникальные экскурсии с FPV-технологиями. Современный и удобный интерфейс для удобного бронирования туров и повышения интереса к экскурсиям",
    description:
      "Проект по разработке сайта для компании «Активный отдых Владимир», предлагающей уникальные экскурсии с FPV-технологиями. Современный и удобный интерфейс для удобного бронирования туров и повышения интереса к экскурсиям",
    image: "cases-active-vacation",
    categories: ["WEB-разработка", "Интеграции", "Сквозная аналитика"],
    isGlobal: true,
  } satisfies TCase;
